...
static int32_t duty = 5000, dir = 0;
...
#define SAMPLE_DEVICE_NAME          "GATINHO"
    ...
    switch (event) {
        ...
        case ESP_GATTS_WRITE_EVT:
            if (!param->write.is_prep){
                ...
                if(strcmp((char*)param->write.value,frente)==0){
                    dir = 1;
                    direcao(dir,duty);
                     ESP_LOGI(GATTS_TABLE_TAG, "chegou");
                }
                else if(strcmp((char*)param->write.value,direita)==0){
                    dir = 2;
                    direcao(dir,duty);
                    ESP_LOGI(GATTS_TABLE_TAG, "chegou d");
                }
                else if(strcmp((char*)param->write.value,esquerda)==0){
                    dir = 3;
                    direcao(dir,duty);
                    ESP_LOGI(GATTS_TABLE_TAG, "chegou e");
                }
                else if(strcmp((char*)param->write.value,re)==0){
                    dir = 4;
                    direcao(dir,duty);
                    ESP_LOGI(GATTS_TABLE_TAG, "chegou r");
                }
                else if(strcmp((char*)param->write.value,parar)==0){
                    dir = 1;
                   direcao(dir,0);
                   ESP_LOGI(GATTS_TABLE_TAG, "chegou p");
                }
                else if(strcmp((char*)param->write.value,tremilique)==0){
                    tremelica();
                }
